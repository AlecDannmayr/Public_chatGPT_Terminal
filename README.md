...
.env``` file and open it, you should see ```API_KEY=""``` in this file where you will need to get and add a key. If you don't have a .env file, create one and add the code below and save the file.
...
11. Copy and paste this key back into your .env file in VsCode or your textEdit/notepad inside the API_KEY quotations: 
